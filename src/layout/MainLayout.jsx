...
const MainLayout = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[var(--background)] text-[var(--text-primary)]">{user && <Navbar />}<AnimatePresence mode="wait" className="flex-grow">
        <motion.div
      ...
      </AnimatePresence><FloatingConnectButton />
    </div>
  );
};
